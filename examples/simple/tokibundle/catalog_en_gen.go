...
var writers_en = map[string]func(w io.Writer, args ...any) (int, error){
	...
	msg73df838e3688e65c: func(w io.Writer, args ...any) (written int, err error) {
	...
	msg7b4460496c4dc063: func(w io.Writer, args ...any) (written int, err error) {
		var n int
	...
	msg7ba5e4f7ff9e557f: func(w io.Writer, args ...any) (written int, err error) {
		return wrs(w, "translated text")
	},
	msga386be7d32b02521: func(w io.Writer, args ...any) (written int, err error) {
		var n int
	...
	msgba9076fe8292afb0: func(w io.Writer, args ...any) (written int, err error) {
		var n int
